...
function base64ToFileBlob(base64String, filename) {
  const contentType = base64String
    .split(",")[0]
    .replace(/^data:([a-z]*\/[a-z]+);base64,/, "");
  const data = Buffer.from(
    base64String.replace(/^data:([a-z]*\/[a-z]+);base64,/, ""),
    "base64"
  );
  return {
    fieldname: "file", // Adjust as needed (field name expected by Multer)
...
module.exports.base64ToFileBlob = base64ToFileBlob;
