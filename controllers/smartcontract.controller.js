    ...
    return new Promise(async function(resolve,reject){
        try{
            ...
            if(address===undefined){
                ...
                res.status(200).json({status:true,address:address.Items[0].address,active_phase:address.Items[0].active_phase,list:address.Items[0].list,theme:address.Items[0].theme})
            }
        }
        }
        catch(err){
