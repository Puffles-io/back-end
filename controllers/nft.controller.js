    ...
    return new Promise(async function(resolve,reject){
        try{
            if(!Boolean(req.body.title||req.body.description||req.body.file_url||req.body.placeholder_image)){
                ...
                let placeholder_image=await  uploadImage(req.body.placeholder_image);
                let nft=new NFT({title:req.body.title,description:req.body.description,file_url:file_url,placeholder_image:placeholder_image,detailed_reveal:req.body.detailed_reveal})
                await nft.save()
