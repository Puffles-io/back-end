                    ...
                    if(results===undefined){
                        ...
                        if(req.body.hasOwnProperty("address")){
                            ...
                            const updatedParams={
                                TableName:'puffles',
                                Key:{PK:`ADR#${req.user.address}`,SK:`ART#${req.body.artwork_id}`},
                                UpdateExpression:"set #address=:address,#mint_structure=:mint_structure,#chain=:chain,#revenue_split_address=:revenue_split_address,#revenue_shares=:revenue_shares,#mint_structure_type=:mint_structure_type",
                                ExpressionAttributeNames:{"#address":"address","#mint_structure":"mint_structure","#chain":"chain","#revenue_split_address":"revenue_split_address","#revenue_shares":"revenue_shares","#mint_structure_type":"mint_structure_type"},
                                ExpressionAttributeValues:{":address":req.body.address,":mint_structure":req.body.mint_structure,":chain":req.body.chain,":revenue_split_address":req.body.revenue_split_address,":revenue_shares":req.body.revenue_shares,":mint_structure_type":req.body.mint_structure_type}
                            }
                            await DatabaseHelper.prototype.updateItems(updatedParams)
                            ...
                            const updatedParams={
                                TableName:'puffles',
                                Key:{PK:`ADR#${req.user.address}`,SK:`ART#${req.body.artwork_id}`},
                                UpdateExpression:"set #sale=:sale,#mint_structure=:mint_structure,#chain=:chain,#revenue_split_address=:revenue_split_address,#revenue_shares=:revenue_shares,#mint_structure_type=:mint_structure_type",
                                ExpressionAttributeNames:{"#sale":"sale_date","#mint_structure":"mint_structure","#chain":"chain","#revenue_split_address":"revenue_split_address","#revenue_shares":"revenue_shares","#mint_structure_type":"mint_structure_type"},
                                ExpressionAttributeValues:{":sale":req.body.sale_date,":mint_structure":req.body.mint_structure,":chain":req.body.chain,":revenue_split_address":req.body.revenue_split_address,":revenue_shares":req.body.revenue_shares,":mint_structure_type":req.body.mint_structure_type}
                            }
                            await DatabaseHelper.prototype.updateItems(updatedParams)
        ...
        try{
            if(!Boolean(req.body.artwork_id)){
                ...
                if(results===undefined){
                    ...
                    res.status(200).json({status:true,message:"List updated successfuly"})
                }
        ...
        try{
            if(!Boolean(req.body.artwork_id)){
                ...
                if(results===undefined){
                    ...
                    res.status(200).json({status:true,message:"URI updated successfuly"})
                }
